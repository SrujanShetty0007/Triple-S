/**
 * Auto PDF Scanner for 2025 Scheme
 */

class PDFScanner2025 {
    constructor() {
        this.pdfCache = new Map();
        this.manifestPath = '2025_scheme/manifest.json';
    ...
    clearCache() {
        ...
        localStorage.setItem('pdf_cache_cleared_2025', Date.now().toString());
    }
...
window.pdfScanner2025 = new PDFScanner2025();

// Initialize when the document is ready
document.addEventListener('DOMContentLoaded', () => {
    window.pdfScanner2025.init();
});